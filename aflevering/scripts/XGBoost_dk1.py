...
val_set = val_set.loc[val_set['Con'] < 3500]
val_set = val_set.loc[val_set['Con'] > 1100]
y_val = val_set['Con']
...
forecast_df = forecast_df.reindex(columns=['grad_dage', 'is_holiday', 'hour','Con'])
...
plt.subplot(1, 1, 1)
plt.title('Predicted vs Exact values for DK2 by the XGBoost model')
plt.plot(np.arange(0,range_len), test_plot['exact_values'], 'r-',
         label='Exact values')
plt.plot(np.arange(0,range_len), test_plot['predicted_values'], 'b-',
         label='Precited Values')
...
plt.subplot(1, 1, 1)
plt.title('Predicted and Exact values for DK1 by the XGB model', fontsize=20)
plt.plot(np.arange(0,range_len), test_plot['exact_values'], 'r-',
         label='Exact values')
plt.plot(np.arange(0,range_len), test_plot['predicted_values'], 'b-',
         label='Precited Values')
